            ...
            <footer class="footer w-100 fixed-bottom" id="mastfoot">
                <div class="row px-3 px-md-4 py-2 m-auto w-100">
                    <a href="<?= home_url();?>/" class="d-flex flex-column col align-items-center justify-content-center h-100 p-0">
                ...
                <script type="text/javascript" src="<?= home_url();?>/assets/js/swiper-bundle.min.js"></script>
                ...
                ?>
                    var global = <?= $localizeScripts;?>;
                </script>
                <script type="text/javascript" id="scripts" src="<?= home_url();?>/assets/js/scripts.js?v=<?= tags_version();?>"></script>
                <?php if( !empty($gameProviders) && $page['page_slug'] == 'home' ) {
                    $json_gameProvider = json_encode($gameProviders, JSON_FORCE_OBJECT);
                    ?>
                    <script id="scripts-home-extra">var gameProviders = <?= $json_gameProvider;?>;</script>
                    <script id="scripts-home" type="text/javascript" src="<?= home_url();?>/assets/js/scripts-home.js?v=<?= tags_version();?>"></script>
                    <?php
                } 
                ?>
