<footer class="footer w-100 fixed-bottom" id="mastfoot">
    <div class="row px-4 py-2 m-auto w-100">
        ...
        <a href="<?=$site_base_url;?>/bonus-promotion" class="d-flex flex-column col align-items-center justify-content-center h-100 p-0">
        ...
        <a href="<?=$site_base_url;?>/slot" class="d-flex flex-column col align-items-center justify-content-center h-100 p-0">
            <img src="<?php echo $site_base_url;?>/images/footer-deposit.png" class="icon img-fit" alt="Deposit">
            <span class="text-center">Slot</span>
        </strong></a>
        <a href="<?=$site_base_url;?>/contact-us" class="d-flex flex-column col align-items-center justify-content-center h-100 p-0">
