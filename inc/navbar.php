        ...
        <div class="navbar-row">
            ...
            <div class="collapse navbar-collapse justify-content-xl-end" id="main-navigation">
                <div class="navbar-collapse-inner">
                    <h4 class="d-block text-center p-4 py-2 title-logo mb-0"><a href="<?php echo $site_base_url;?>" class="d-block"><img src="<?php echo $site_base_url;?>/images/winmyr_logo.webp" alt="LPK777 Logo" class="img-fit mx-auto"></a></h4>
