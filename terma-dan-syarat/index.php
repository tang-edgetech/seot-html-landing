                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 px-4">
                            <div class="text-editor">
                                ...
                                <p class="mb-3">Sila baca dengan teliti Terma dan Syarat berikut sebelum menggunakan laman web dan perkhidmatan WINMY. Dengan mengakses dan menggunakan <a href="<?= $site_base_url;?>/muat-turun-apk/"><strong>aplikasi official WINMY</strong></a>, anda bersetuju untuk mematuhi semua peraturan dan syarat yang dinyatakan.</p>
                                <ol>
