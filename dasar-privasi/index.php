...
<html lang="en-MY" dir="ltr">
    <head>
        ...
        <title>Dasar Privasi JOM99 - Perlindungan Data Pengguna yang Penuh di Malaysia</title>
        <meta name="title" content="Dasar Privasi JOM99 - Perlindungan Data Pengguna yang Penuh di Malaysia">
        <meta name="description" content="Baca dasar privasi JOM99 dan ketahui bagaimana kami melindungi maklumat peribadi anda. Kami komited untuk menjaga privasi dan keselamatan data semua pengguna.">
        ...
        <meta itemprop="name" content="Dasar Privasi JOM99 - Perlindungan Data Pengguna yang Penuh di Malaysia">
        <meta itemprop="description" content="Baca dasar privasi JOM99 dan ketahui bagaimana kami melindungi maklumat peribadi anda. Kami komited untuk menjaga privasi dan keselamatan data semua pengguna.">
        ...
        <meta name="twitter:title" content="Dasar Privasi JOM99 - Perlindungan Data Pengguna yang Penuh di Malaysia">
        <meta name="twitter:description" content="Baca dasar privasi JOM99 dan ketahui bagaimana kami melindungi maklumat peribadi anda. Kami komited untuk menjaga privasi dan keselamatan data semua pengguna.">
        ...
        <script type="application/ld+json">
        {
            ...
            "itemListElement": [
                ...
                "position": 2,
                "name": "Dasar Privasi",
                "item": "https://jom99.org/dasar-privasi/"
                }
            ]
        }
        </script>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 px-4">
                            <div class="text-editor">
                                ...
                                <ol>
                                    <li class="mb-3"><strong>Pengumpulan Maklumat</strong><br/>Kami mengumpul maklumat peribadi seperti nama, alamat emel, nombor telefon, dan maklumat pembayaran apabila anda mendaftar atau membuat transaksi di JOM99. Selain itu, kami juga mengumpul data penggunaan laman seperti alamat IP, jenis peranti, dan aktiviti permainan untuk meningkatkan perkhidmatan.</li>
                                    <li class="mb-3"><strong>Penggunaan Maklumat</strong><br/>Maklumat yang dikumpul digunakan untuk:<br/>
                                        <ul>
                                            ...
                                            <li>Menghantar <a href="https://jom99.org/bonus-promosi/"><strong>senarai promosi terkini</strong></a>, bonus, dan maklumat penting lain.</li>
                                    ...
                                    <li class="mb-3"><strong>Perkongsian Maklumat</strong><br/>Kami tidak menjual atau menyewakan maklumat peribadi anda kepada pihak ketiga. Namun, maklumat anda mungkin dikongsi dengan:<br/>
                                        <ul>
                                            <li>Penyedia <a href="https://jom99.org/kaedah-pembayaran/"><strong>pilihan pembayaran yang disokong</strong></a> untuk memproses transaksi.</li>
                                    ...
                                    <li><strong>Hubungi Kami</strong><br/>Jika anda mempunyai sebarang pertanyaan atau kebimbangan mengenai polisi privasi ini, sila hubungi kami melalui halaman <a href="https://jom99.org/hubungi-kami/"><strong>Khidmat Pelanggan Rasmi JOM99</strong></a>.</li>
                                </ol>
                                <p>&nbsp;</p>
