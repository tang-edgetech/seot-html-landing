                        ...
                        <div class="col-12 px-4">
                            <div class="d-flex flex-wrap p-3 userprofile-container w-100 mt-3" id="userProfileModule">
                                <div class="d-flex flex-wrap p-0 m-0 w-100 justify-content-between mb-3">
                                    <a class="btn-style text-uppercase btn-section-bg col-6 text-center" style="max-width: 48.5%;" type="button" alt="Register Button" href="https://win111.one/register/?affiliateCode=win111v1seo2">Daftar</a>
                                    <a class="btn-style text-uppercase btn-primary col-6 text-center" style="max-width: 48.5%;" type="button" alt="Login Button" href="https://win111.one/register/?affiliateCode=win111v1seo2">Log Masuk</a>
                                </div>
                                <div class="d-flex m-0 p-0 w-100">
                                    ...
                                    <div class="col-5 px-0 ">
                                        <div class="row m-0 p-0 w-100">
                                            <a class="btn-style btn-primary w-100" type="button" alt="Deposit Button" href="https://win111.one/register/?affiliateCode=win111v1seo2" target="_blank" rel="nofollow noreferrer noopener">
                                            ...
                                            <a class="btn-style btn-section-bg w-100 mt-2 " type="button" alt="withdraw Button" href="https://win111.one/register/?affiliateCode=win111v1seo2" target="_blank" rel="nofollow noreferrer noopener">
                                                <div class="d-flex align-items-center">
                                            ...
                                            <a class="btn-style btn-section-bg w-100 mt-2" type="button" alt="refresh Button" href="https://win111.one/register/?affiliateCode=win111v1seo2" target="_blank" rel="nofollow noreferrer noopener">
                                                <div class="d-flex align-items-center">
